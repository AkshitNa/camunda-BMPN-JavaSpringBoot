...
@RestController
public class ServiceTaskExpressionController {

    //http://localhost:8080/executeServiceTask
    @GetMapping("/executeServiceTask")
    public String execute(){
        ...
        ProcessInstantiationBuilder instance = engine.getRuntimeService().createProcessInstanceByKey("ServiceTaskExecute");
        ...
        return "Camunda Modeler BPMN has executed the Service Task";
    }
}
